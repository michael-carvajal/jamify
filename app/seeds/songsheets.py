...
def seed_songsheets():
    ...
    if(os.environ.get("FLASK_ENV") == "production"):
        chrome_options.binary_location = '/opt/render/project/.render/chrome/chromedriver/google-chrome-stable'  # Update with the correct Chrome binary location in WSL
    else:
